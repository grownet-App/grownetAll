...
export const otpApiUrl = 'http://ec2-18-191-177-149.us-east-2.compute.amazonaws.com/grownet/api/authenticate/login'
...
export const ApiSuppliers = 'http://5.161.211.8:88/api/providers/all' 